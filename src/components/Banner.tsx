  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 px-4 lg:px-24 pt-12 lg:pt-24">
        <div className="">
          <button className="flex items-center gap-4 bg-slate-100 py-3 px-4 rounded-2xl text-[#F85E9F] font-bold text-sm">
            Explore the world!
            <Building2 />
          </button>
          ...
          <div className="flex gap-6">
            <button className="mt-11 bg-[#5D50C6] rounded-full text-white text-sm font-bold py-3 px-6">
              Get Started
            </button>
